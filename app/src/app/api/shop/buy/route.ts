...
const MINT_ENV: Record<string, string> = {
  ...
  "T-OPENAI": "NEXT_PUBLIC_MINT_T_OPENAI",
  "T-KALSHI": "NEXT_PUBLIC_MINT_T_KALSHI",
  "PRE-ANTHROPIC": "NEXT_PUBLIC_MINT_PRE_ANTHROPIC",
  "PRE-SPACEX": "NEXT_PUBLIC_MINT_PRE_SPACEX",
};

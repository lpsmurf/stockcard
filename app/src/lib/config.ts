...
export type PriceSource = "Pyth" | "Appraisal" | "PartnerFmv" | "Demo";
...
export const MARKETS: MarketInfo[] = [
  { symbol: "NVDAx", name: "NVIDIA (xStock)", assetClass: "Equity", priceSource: "Pyth", maxLtvBps: 5000, liqThresholdBps: 6500, haircutBps: 0 },
  { symbol: "SPYx", name: "S&P 500 ETF (xStock)", assetClass: "Equity", priceSource: "Pyth", maxLtvBps: 5000, liqThresholdBps: 6500, haircutBps: 0 },
  { symbol: "SPCX", name: "SpaceX (Backpack)", assetClass: "Equity", priceSource: "Demo", maxLtvBps: 5000, liqThresholdBps: 6500, haircutBps: 0 },
  ...
  { symbol: "PSA10", name: "PSA 10 graded card", assetClass: "Collectible", priceSource: "PartnerFmv", maxLtvBps: 4000, liqThresholdBps: 5500, haircutBps: 2500 },
];
